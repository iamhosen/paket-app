<template>
  <div
    ...
    @click="onClick"
  >
    <div class="w-full h-full p-4 flex flex-col gap-y-4">
      <h3>{{ card.name }}</h3>
      <span class="font-xero ltr text-center tracking-wider">
        {{ styledCardNumber }}
      </span>
      <span class="flex flex-col">
        <p class="font-normal text-xs opacity-40">موجودی</p>
        <p class="font-bold text-sm tracking-widest">
